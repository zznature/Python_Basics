...
ax.text(X0[0] - 0.25, y + 0.2, "Line color",
...
ax.text(X0[0] - 0.25, y + 0.2, "Line width",
        size="small", ha="left", va="baseline")
...
ax.text(X0[0] - 0.25, y + 0.2, "Cap style",
        size="small", ha="left", va="baseline")
...
for x0, x1, style in zip(X0, X1, styles):
    ...
    ax.text((x0 + x1) / 2, y - 0.2, '"%s"' % style,
            size="x-small", ha="center", va="top", family="monospace")
ax.text(X0[0] - 0.25, y + 0.2, "Dash cap style",
        size="small", ha="left", va="baseline")
...
for x0, x1, style in zip(X0, X1, styles):
    ...
    ax.text((x0 + x1) / 2, y - 0.2, text,
            size="x-small", ha="center", va="top", family="monospace")
ax.text(X0[0] - 0.25, y + 0.2, "Line style",
        size="small", ha="left", va="baseline")
...
ax.text(X0[0] - 0.25, y + 0.2, "Antialias",
        size="small", ha="left", va="baseline")
